(function (exports) {
    ...
    class GridAppBlockComponent extends GridAppComponent {
        ...
        get headElement() {
            return this.element.querySelector(`.component-head`);
        }
        get bodyElement() {
            return this.element.querySelector(`.component-body`);
        }
        get title() {
        ...
        _createConnector(label, connectorType) {
        ...
        export() {
            ...
            for (const connectorElement of connectorElements) {
                const connector = connectorElement.gridAppInstance;
                connectors.push({
    ...
    exports.GridAppBlockComponent = GridAppBlockComponent;
